...
export const AllStoriesPage = ({ stories = [], onBack }) => {
    ...
    <div className="min-h-screen bg-[#04060d] text-slate-100 py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        {filteredStories.length > 0 ? (
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-7 pt-4">
            {filteredStories.map((story, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative w-full h-28 sm:h-48 overflow-hidden rounded-t-2xl sm:rounded-t-[1.8rem] bg-slate-950">
                    {story.image && (
                      <img
                        src={story.image}
                        alt={story.title}
                  ...
                  <div className="p-3.5 sm:p-6 flex-1 flex flex-col justify-between space-y-2.5 sm:space-y-4">
                    <div className="space-y-1.5 sm:space-y-2">
                      <h3 className="text-xs sm:text-lg font-bold text-white group-hover:text-pink-300 transition-colors font-heading leading-snug line-clamp-2">
                        {story.title}
                      </h3>
                    ...
                    <div className="pt-2 sm:pt-3 border-t border-white/5 space-y-2 sm:space-y-3">
                      <div className="flex flex-col xs:flex-row xs:items-center justify-between text-[9px] sm:text-xs text-slate-500 gap-1">
